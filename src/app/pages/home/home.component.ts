...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.store
      ...
      .subscribe((activitiesFromStore: IActivity[]) => {
        ...
        this.totalPages = (activitiesFromStore.length > 0)
          ? Math.ceil(activitiesFromStore.length / this.itemsPerPage)
          : 1;
      });
   ...
   */
  handleFilterChange(name: keyof IActivityFilters, value: string): void {
